      ...
      <div className="bg-gray-900">
        <div>
          <div className="relative">
            ...
            {/* For md screen size */}
            {/* For large screens */}
            <div className="dark:bg-gray-900 bg-gray-70 px-6 py-9">
              <div className="container mx-auto flex items-center justify-between">
                <h1
                  className="md:w-2/12 cursor-pointer font-extrabold text-4xl text-white dark:text-white"
                  aria-label="shopAlon."
                >
                  Xtoons.
                  {/* <svg
                ...
                <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                  <li>
                    <a
                      href="/"
                      className="dark:text-white text-base text-white font-bold text-xl  hover:text-green-300"
                    >
                      cartoons
                    </a>
                  </li>
                  <li>
                    <a
                      href="#"
                      className="dark:text-white text-base text-white text-xl font-bold  hover:text-green-300"
                    >
                      cartoons
                    </a>
                  </li>
                  ...
                  <li>
                    <a
                      href="#"
                      className="dark:text-white text-xl font-bold text-base text-white   hover:text-green-300"
                    >
                      About
                    </a>
                  </li>
                ...
                <div className="w-2/5  justify-end flex items-center space-x-4 xl:space-x-8">
                  {/* <div className="hidden lg:flex items-center">
                    <button
                      ...
                      className="text-white dark:hover:text-gray-300 dark:text-white "
                    >
                      <svg
                        className="fill-stroke"
                        width={24}
                  ...
                  <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                    ...
                    {/* <>
                      <button
                        ...
                        className="w-24 bg-red-600 text-white font-bold h-10 rounded-2xl "
                      >
                        Sign Up
                      </button>
                    </> */}
                    <motion.button
                      ...
                      className="w-40 bg-red-600 text-white  font-bold h-10 rounded-3xl "
                    >
                      Sign In
                    </motion.button>
                  </div>
                  <div className="flex lg:hidden">
                    ...
                    <button
                      ...
                      className=" dark:text-white text-white dark:hover:text-gray-300 md:hidden focus:outline-none focus:ring-2 rounded focus:ring-gray-600"
                    >
                      <svg
                        className="fill-stroke"
                        width={24}
            ...
            <div
              ...
              } absolute dark:bg-gray-900 z-20 bg-gray-800 inset-0 md:hidden  flex-col h-80 w-full`}
            >
              <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4 p-4">
                ...
                >
                  <svg
                    className="fill-stroke text-gray-50 dark:text-white"
                    width={16}
                    height={16}
                    viewBox="0 0 16 16"
                    fill="none"
              ...
              <div className="mt-6 p-4">
                <ul className="flex flex-col space-y-6">
                  <li>
                    <a
                      href="/"
                      className="dark:text-white flex items-center justify-between hover:underline text-base text-white focus:outline-none focus:ring-2 focus:ring-gray-800"
                    >
                      cartoons
                      <div>
                        <svg
              ...
              <div className="h-full flex items-end">
                <>
                  <ul className="flex flex-col justify-center items-center space-y-8 bg-gray-800 w-full py-10 p-4 dark:bg-gray-800">
                    <li>
                      <a
                        href="#"
                      ...
                      >
                        <div>
                          <button className="w-60 bg-red-600 text-white font-bold h-10 rounded-3xl">
                            Sign Up
                          </button>
                        </div>
                      </a>
